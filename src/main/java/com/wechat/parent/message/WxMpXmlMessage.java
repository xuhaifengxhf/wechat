...
public class WxMpXmlMessage implements Serializable {
   ...
   */
  public static WxMpXmlMessage fromEncryptedXml(String encryptedXml,String timestamp, String nonce,
                                                String msgSignature) {
    WxMpCryptUtil cryptUtil = new WxMpCryptUtil();
    String plainText = cryptUtil.decrypt(msgSignature, timestamp, nonce,
      encryptedXml);
    return fromXml(plainText);
  }

  public static WxMpXmlMessage fromEncryptedXml(InputStream is, String timestamp, String nonce,
                                                String msgSignature) {
    try {
